...
<div class="hero-image">
  <img src="assets/logo.png" alt="Logo do Projeto" class="img-destaque" width="200" />
</div>

## Bem-vindo

Esta é a documentação centralizada de requisitos de software para nosso projeto web. Aqui você encontrará toda a especificação, requisitos funcionais e não-funcionais, além de documentação técnica e casos de uso.
